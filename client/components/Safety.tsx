            ...
            <div className="column is-three-fifths is-offset-one-fifth">
              ...
              <div className="block">
                <p>
                  ...
                  consumption of Vegemite over one's lifetime effectively
                  inoculates oneself for reasons not yet understood by science.
                </p>
              </div>
              ...
              <div className="block">
                <p>
                  ...
                  technique. From the lofty heights of eucalyptus trees, Drop
                  Bears wait patiently for unsuspecting prey to amble though the
                  forest. When the moment is right, they drop down with
                  astonishing speed and accuracy onto their prey below. With
                  powerful jaws and sharp claws, they can deliver quite a
                  surprise to anyone caught off guard.
                </p>
              </div>
              ...
              <div className="block">
                <p>
                  <p className="has-text-weight-semibold">Stay Vigilant:</p> Be
                  on the look out for any suspicious rustling or movement from
                  the trees above. Drop bears will leave you alone if you force
                  them to make unnecessarily long or uncomfortably intimate eye
                  contact.
                </p>
              </div>
              ...
              <div className="block">
                <p>
                  ...
                  Australian. It's important to note that if a drop bear
                  discovers your accent is fake they will become violent, almost
                  demonically so.
                </p>
              </div>
              ...
              <div className="block">
                <p>
                  ...
                  Like most animals, the drop bear has a strong sense of smell,
                  they can sniff out a tourist over a kilometer away. To protect
                  yourself rub a bit of vegemite behind your ear.
                </p>
              </div>
              ...
              <div className="block">
                <p>
                  ...
                  who are wearing protective head gear. Effective head gear can
                  include spiked helmets also known as Pickelhaubes. For a more
                  cost effective solution weaving sharpened forks into your hair
